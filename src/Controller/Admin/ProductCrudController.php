...
class ProductCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield NumberField::new('depth', 'Profondeur (mm)')->hideOnIndex();        yield NumberField::new('height', 'Hauteur (mm)')->hideOnIndex();
        yield BooleanField::new('showcaseProduct', 'Produit en vitrine');
        ...
        yield AssociationField::new('images', 'Images')->hideOnIndex();
